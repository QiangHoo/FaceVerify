package com.arcsoft.arcfacedemo.loadtoast;
...
public class LoadToastView extends ImageView {
    ...
    private ToastAnimationFinish mListener;

    public interface ToastAnimationFinish{
        void onFinished();
    }

    public void setOnToastAnimationFinish(ToastAnimationFinish listener){
    ...
    public LoadToastView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void initSpinner(int repeatCount){
        ...
        spinnerDrawable.setupAnimators(repeatCount);
        spinnerDrawable.setOnCircleAnimationListener(new MaterialProgressDrawable.CircleAnimationFinish() {
            @Override
