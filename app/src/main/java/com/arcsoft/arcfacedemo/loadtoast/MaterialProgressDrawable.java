...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private CircleAnimationFinish mListener;

    public interface CircleAnimationFinish{
        void onFinished();
    }

    public void setOnCircleAnimationListener(CircleAnimationFinish listener){
    ...
    public void setupAnimators(int repeatCount) {
        final Ring ring = mRing;
